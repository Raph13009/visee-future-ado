...
const BilanPublic = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#F9F8F4' }}>
      ...
      <section className="relative flex items-center justify-center" style={{ height: '50vh', minHeight: '400px', backgroundImage: 'url("/other.png")', backgroundSize: 'cover', backgroundPosition: 'center top' }}>
