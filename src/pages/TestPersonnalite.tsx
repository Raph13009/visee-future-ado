      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        ...
        <div className="mb-12 rounded-3xl border border-slate-200 bg-white p-6 shadow-xl sm:p-8">
          ...
          <button
            ...
            className="w-full rounded-xl bg-[#117B4D] px-6 py-4 text-lg font-semibold text-white shadow-lg transition hover:bg-[#0d5f3a] hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#117B4D] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isGenerating ? (
                      ...
                      <div className="grid grid-cols-5 gap-3 text-center text-[11px] font-medium text-slate-400">
                        {["Strongly Disagree", "Disagree", "Neutral", "Agree", "Strongly Agree"].map((label, index) => (
                          <div key={label} className="space-y-2">
                            <div
                              className={`mx-auto flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 ${
              ...
              {currentStepIndex === 0 && (
                <div className="flex justify-end">
                  <button
                    ...
                    title="Remplir automatiquement toutes les réponses avec des valeurs aléatoires et aller directement à la dernière page"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
